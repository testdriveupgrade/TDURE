...
# Codegen target - run 'cmake --build . --target testrec_codegen'
add_custom_target(testrec_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/testrec_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for testrec"
    VERBATIM
)
